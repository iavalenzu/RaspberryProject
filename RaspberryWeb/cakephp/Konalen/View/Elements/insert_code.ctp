...
<?php if(isset($headcode)): ?>


<?php 
    $headcode = preg_replace("/'/", '"', $headcode);
    //Reemplazamos cualquier caracter espacio en blanco enter, tab por un espacion en blanco simple
    $headcode = preg_replace("/\s+/", " ", $headcode); 
?>

window.addEvent('domready', function() {

        //Reemplazamos las comillas simples por doble, y los enter por espacios

	var headcode = Elements.from('<?php echo $headcode; ?>', true);
	var head = document.getElement('head');
	/*Agregamos al head el nuevo codigo*/
	headcode.inject(head, 'bottom'); 
...
//Se crea el elemento que se desea insertar en la posicion del script
var content = Elements.from('<?php echo $content; ?>');
