...
class ApiController extends AppController {
    ...
    public function checklogin() {
        ...
        $form_id = Utilities::exists($this->request->data['Form'], 'form_id', Utilities::$REQUIRED, Utilities::$NOT_EMPTY, false);
        $service_id = Utilities::exists($this->request->data['Form'], 'service_id', Utilities::$REQUIRED, Utilities::$NOT_EMPTY, false);
        $transaction_id = Utilities::exists($this->request->data['Form'], 'transaction_id', Utilities::$REQUIRED, Utilities::$NOT_EMPTY, false);

        $user_id = Utilities::exists($this->request->data['Form'], 'user_id', Utilities::$REQUIRED, Utilities::$EMPTY, false);
        $user_pass = Utilities::exists($this->request->data['Form'], 'user_pass', Utilities::$REQUIRED, Utilities::$EMPTY, false);
        $captcha_code = Utilities::exists($this->request->data['Form'], 'captcha_code', Utilities::$NOT_REQUIRED, Utilities::$EMPTY, false);
        ...
        if (empty($service_form)) {
            ...
            if ($account_identity) {
                ...
                if ($service['Service']['two_step_auth'] == 1) {
                    ...
                    $account_access = $this->AccountAccess->createAccess($account_identity['Account']['id'], $service['Service']['session_timeout']);
