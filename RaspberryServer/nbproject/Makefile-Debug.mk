...
${OBJECTDIR}/ActionPersistentConnection.o: ActionPersistentConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ActionPersistentConnection.o ActionPersistentConnection.cpp
...
${OBJECTDIR}/NotificationReader.o: NotificationReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NotificationReader.o NotificationReader.cpp

${OBJECTDIR}/NotificationWriter.o: NotificationWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NotificationWriter.o NotificationWriter.cpp
